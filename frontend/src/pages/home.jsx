...
function Home(props) {
    ...
    return (
      ...
      {/* <Link to="/describtion"> <button className="mt-8 px-6 sm:px-12 py-2 sm:py-3 text-lg sm:text-2xl  md:text-3xl text-white bg-blue-950 rounded-lg"> Show more </button></Link>  */}
          </div>
       {/* 2 */}
